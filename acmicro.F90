...
! -----------------------------------------------------------
    ZEFFA = EXP(YRPHY0%RAUTSBET*ZDELT)
...
! --------------------------------------------------
    ...
    ZAUTOI = MAX(0.0_JPRB,ZDUM)
 
! TOTAL AUTOCONVERSION TERM
! -------------------------

    PAUTOL(JLON,JLEV) = ZAUTOL * PNEBST(JLON,JLEV)
    PAUTOI(JLON,JLEV) = ZAUTOI * PNEBST(JLON,JLEV)
