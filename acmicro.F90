...
ASSOCIATE(RAUTEFR=>YRPHY0%RAUTEFR, RAUTEFS=>YRPHY0%RAUTEFS, &
 & RQICRT1=>YRPHY0%RQICRT1, RQICRT2=>YRPHY0%RQICRT2, RQICRSN=>YRPHY0%RQICRSN, &
 & RQLCR=>YRPHY0%RQLCR, RAUTSBET=>YRPHY0%RAUTSBET, RQICRMIN=>YRPHY0%RQICRMIN, &
 & RQICRMAX=>YRPHY0%RQICRMAX, &
 & TMERGL=>YRPHY1%TMERGL, &
 & TSPHY=>YRPHY2%TSPHY)
