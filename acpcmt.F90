...
SUBROUTINE ACPCMT ( KIDIA,KFDIA,KLON,KTDIA,KLEV,KTRA,&
  ...
  ! - INPUT/OUTPUT 2D .
  & PUDAL,PUDOM,PDDAL,PDDOM, KSTACK, PSTACK, KPSTSZ, KKSTSZ)
...
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, ZQLC, PQL, PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U, ZDETR_D, PFEDQLC, KSTACK, PSTACK, KPSTSZ, KKSTSZ)
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, ZQIC, PQI, PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U, ZDETR_D, PFEDQIC, KSTACK, PSTACK, KPSTSZ, KKSTSZ)
...
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, ZQRC, PRR, PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U_RS, ZDETR_D_RS, PFEDQRC, KSTACK, PSTACK, KPSTSZ, KKSTSZ)
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, ZQSC, PS,  PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U_RS, ZDETR_D_RS, PFEDQSC, KSTACK, PSTACK, KPSTSZ, KKSTSZ)
...
IF(YRPHY%LNEBNXR) THEN
  ...
  CALL ACNEBXRS ( KIDIA,KFDIA,KLON,KTDIA,KLEV,&
    ...
    & ZNEBC_MICRO, KSTACK, PSTACK, KPSTSZ, KKSTSZ)
  DO JLEV = KTDIA, KLEV
    DO JLON = KIDIA, KFDIA
...
CALL ACPLUIZ ( KIDIA,KFDIA,KLON,KTDIA,KLEV,&
  ...
  & PFPEVPCL, PFPEVPCN, PFPFPCL, PFPFPCN, PDIFCQLC, PDIFCQIC, KSTACK, PSTACK, KPSTSZ, KKSTSZ )
...
CALL ACADVEC (KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, PAPHI, ZQLC, ZW_CONV, PDIFCQLC, KSTACK, PSTACK, KPSTSZ, KKSTSZ)
CALL ACADVEC (KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, PAPHI, ZQIC, ZW_CONV, PDIFCQIC, KSTACK, PSTACK, KPSTSZ, KKSTSZ)

! CONVECTIVE TRANSPORT OF RESOLVED CONDENSATES IN THE ENVIRONMENT.
CALL ACADVEC (KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, PAPHI, PQL, ZW_COMPENS, PDIFCQL, KSTACK, PSTACK, KPSTSZ, KKSTSZ)
CALL ACADVEC (KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, PAPHI, PQI, ZW_COMPENS, PDIFCQI, KSTACK, PSTACK, KPSTSZ, KKSTSZ)
