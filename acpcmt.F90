...
REAL(KIND=JPRB) :: ZDETR_U_RS(KLON,KLEV),ZDETR_D_RS(KLON,KLEV)
...
REAL(KIND=JPRB) :: ZSU(KLON,KLEV) ! Energie statique seche de l'updraft.
...
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, ZQLC, PQL, PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U, ZDETR_D, PFEDQLC, KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT)
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, ZQIC, PQI, PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U, ZDETR_D, PFEDQIC, KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT)
! Detrainment of rain and snow is smaller from that of lagrangian species (liquid and ice).
DO JLEV = KTDIA-1, KLEV
  DO JLON = KIDIA, KFDIA
    ZDETR_U_RS(JLON,JLEV)=YRPHY0%GREDDRS*ZDETR_U(JLON,JLEV)
    ZDETR_D_RS(JLON,JLEV)=YRPHY0%GREDDRS*ZDETR_D(JLON,JLEV)
  ENDDO
ENDDO
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, ZQRC, PRR, PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U_RS, ZDETR_D_RS, PFEDQRC, KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT)
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, ZQSC, PS,  PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U_RS, ZDETR_D_RS, PFEDQSC, KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT)
...
IF(YRPHY%LNEBNXR) THEN
  ...
  CALL ACNEBXRS ( KIDIA,KFDIA,KLON,KTDIA,KLEV,&
    ...
    & ZNEBC_MICRO, KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT)
  DO JLEV = KTDIA, KLEV
    DO JLON = KIDIA, KFDIA
...
CALL ACPLUIZ ( KIDIA,KFDIA,KLON,KTDIA,KLEV,&
  ...
  & PFPEVPCL, PFPEVPCN, PFPFPCL, PFPFPCN, PDIFCQLC, PDIFCQIC, KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT )
...
CALL ACADVEC (KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, PAPHI, ZQLC, ZW_CONV, PDIFCQLC, KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT)
CALL ACADVEC (KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, PAPHI, ZQIC, ZW_CONV, PDIFCQIC, KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT)

! CONVECTIVE TRANSPORT OF RESOLVED CONDENSATES IN THE ENVIRONMENT.
CALL ACADVEC (KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, PAPHI, PQL, ZW_COMPENS, PDIFCQL, KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT)
CALL ACADVEC (KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, PAPHI, PQI, ZW_COMPENS, PDIFCQI, KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT)
...
IF(YRPHY%LCVPPKF.OR.YRPHY%LEDKF) THEN
  ! PAIPCMT: Activity Index of PCMT: 1. if PCMT is active, 0. else case.
  DO JLON=KIDIA,KFDIA
    PAIPCMT(JLON)=MAX(0._JPRB,SIGN(1._JPRB,ZDEPTH(JLON)-YRPHY0%THPCMT))
  ENDDO
...
DO JLEV=KTDIA,KLEV
  DO JLON=KIDIA,KFDIA
    ...
    PCSGC(JLON,JLEV)=YRPHY0%GCVFNER*MAX(0._JPRB,SIGN(1._JPRB,ZDEPTH(JLON)-YRPHY0%GCVFNEO)) &
