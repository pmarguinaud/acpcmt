...
CALL ACADVEC (KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, PAPHI, ZQLC, ZW_CONV, PDIFCQLC, &
            & KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT)
CALL ACADVEC (KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, PAPHI, ZQIC, ZW_CONV, PDIFCQIC, &
            & KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT)

! CONVECTIVE TRANSPORT OF RESOLVED CONDENSATES IN THE ENVIRONMENT.
CALL ACADVEC (KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, PAPHI, PQL, ZW_COMPENS, PDIFCQL, &
            & KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT)
CALL ACADVEC (KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, PAPHI, PQI, ZW_COMPENS, PDIFCQI, &
            & KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT)
