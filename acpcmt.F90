...
temp (REAL(KIND=JPRB), ZDETR_D_RS, (KLON,KLEV))
temp (REAL(KIND=JPRB), ZDETR_U_RS, (KLON,KLEV))
...
CALL ACMTUD ( KIDIA,KFDIA,KLON,KTDIA,KLEV,KTRA,&
  ...
  & KNND(JLON),PCAPE(JLON), ZALF(JLON), PALF_CAPE(JLON), PALF_CVGQ(JLON),&
...
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, ZQLC, PQL, PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U, ZDETR_D, PFEDQLC,ISTPT,KSTSZ,PSTACK)
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, ZQIC, PQI, PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U, ZDETR_D, PFEDQIC,ISTPT,KSTSZ,PSTACK)
...
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, ZQRC, PRR, PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U_RS, ZDETR_D_RS, PFEDQRC,ISTPT,KSTSZ,PSTACK)
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, ZQSC, PS,  PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U_RS, ZDETR_D_RS, PFEDQSC,ISTPT,KSTSZ,PSTACK)
