...
INTEGER(KIND=JPIM) :: JLEV,JLON,INEBC,IQLIC,IQLIC_MICRO
...
ZTMIC(KIDIA:KFDIA,KTDIA:KLEV)=(1._JPRB-YRPHY0%GSHELL)*PTU(KIDIA:KFDIA,KTDIA:KLEV) &
  & +YRPHY0%GSHELL*PT(KIDIA:KFDIA,KTDIA:KLEV)
ZQMIC(KIDIA:KFDIA,KTDIA:KLEV)=(1._JPRB-YRPHY0%GSHELL)*PQU(KIDIA:KFDIA,KTDIA:KLEV) &
  & +YRPHY0%GSHELL*PQ(KIDIA:KFDIA,KTDIA:KLEV)
