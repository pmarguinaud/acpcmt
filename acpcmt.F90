...
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, 1._JPRB, PDELP, ZQLC, PQL, PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U, ZDETR_D, PFEDQLC,ISTPT,KSTSZ,PSTACK)
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, 1._JPRB, PDELP, ZQIC, PQI, PUDAL, PDDAL, &
...
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, YRPHY0%GREDDRS, PDELP, ZQRC, PRR, PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U, ZDETR_D, PFEDQRC,ISTPT,KSTSZ,PSTACK)
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, YRPHY0%GREDDRS, PDELP, ZQSC, PS,  PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U, ZDETR_D, PFEDQSC,ISTPT,KSTSZ,PSTACK)
