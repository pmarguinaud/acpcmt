...
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, ZQLC, PQL, PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U, ZDETR_D, PFEDQLC,KSTPT,KSTSZ,PSTACK)
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, ZQIC, PQI, PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U, ZDETR_D, PFEDQIC,KSTPT,KSTSZ,PSTACK)
...
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, ZQRC, PRR, PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U_RS, ZDETR_D_RS, PFEDQRC,KSTPT,KSTSZ,PSTACK)
CALL ACMTENTR(KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, ZQSC, PS,  PUDAL, PDDAL, &
  & ZENTR_U, ZENTR_D, ZDETR_U_RS, ZDETR_D_RS, PFEDQSC,KSTPT,KSTSZ,PSTACK)
...
IF(YRPHY%LNEBNXR) THEN
  ...
  CALL ACNEBXRS ( KIDIA,KFDIA,KLON,KTDIA,KLEV,&
    ...
    & ZNEBC_MICRO,KSTPT,KSTSZ,PSTACK)
  DO JLEV = KTDIA, KLEV
    DO JLON = KIDIA, KFDIA
...
CALL ACPLUIZ ( KIDIA,KFDIA,KLON,KTDIA,KLEV,&
  ...
  & PFPEVPCL, PFPEVPCN, PFPFPCL, PFPFPCN, PDIFCQLC, PDIFCQIC,KSTPT,KSTSZ,PSTACK )
...
CALL ACADVEC (KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, PAPHI, ZQLC, ZW_CONV, PDIFCQLC,KSTPT,KSTSZ,PSTACK)
CALL ACADVEC (KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, PAPHI, ZQIC, ZW_CONV, PDIFCQIC,KSTPT,KSTSZ,PSTACK)

! CONVECTIVE TRANSPORT OF RESOLVED CONDENSATES IN THE ENVIRONMENT.
CALL ACADVEC (KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, PAPHI, PQL, ZW_COMPENS, PDIFCQL,KSTPT,KSTSZ,PSTACK)
CALL ACADVEC (KIDIA, KFDIA, KLON, KTDIA, KLEV, PDELP, PAPHI, PQI, ZW_COMPENS, PDIFCQI,KSTPT,KSTSZ,PSTACK)
