...
JLON = KIDIA
  ...
  ZRHCRI1=YRPHY0%RHCRIT1+(YRPHY0%RHCRIT2-YRPHY0%RHCRIT1) &
   &           * YRPHY0%GRHCMOD * EXP(-1.0_JPRB/(YRPHY0%TEQH*PGM))
  ZFACT=(YRPHY0%RHCRIT2-ZRHCRI1)/ZFACT0
  ZA=ZFACTA*ZFACT
  ZB=ZFACTB*ZFACT
  ZC=ZFACTC*ZFACT
...
DO JLEV=KTDIA,KLEV
    ...
    PRHCRI(JLON,JLEV) = ZA * ZVETAF(JLEV)**3 &
     & + ZB * ZVETAF(JLEV)**2 &
     & + ZC * ZVETAF(JLEV) &
     & + YRPHY0%RHCRIT2
