...
temp (REAL(KIND=JPRB), ZC, (KLON))
temp (REAL(KIND=JPRB), ZB, (KLON))
temp (REAL(KIND=JPRB), ZA, (KLON))
temp (REAL(KIND=JPRB), ZRHCRI1, (KLON))
...
DO JLON=KIDIA,KFDIA
  ZRHCRI1(JLON)=YRPHY0%RHCRIT1+(YRPHY0%RHCRIT2-YRPHY0%RHCRIT1) &
   &           * YRPHY0%GRHCMOD * EXP(-1.0_JPRB/(YRPHY0%TEQH*PGM(JLON)))
  ZFACT=(YRPHY0%RHCRIT2-ZRHCRI1(JLON))/ZFACT0
