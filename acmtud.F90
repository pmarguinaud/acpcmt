...
ELSE
  ...
  DO JLON=KIDIA,KFDIA
    ...
    ZALFX(JLON)=MAX(YRPHY0%ALFX_LR,MIN(YRPHY0%ALFX_HR,YRPHY0%ALFX_LR+(ZRESOL-YRPHY0%GCVRESN)/(YRPHY0%GCVRESX-YRPHY0%GCVRESN)*(YRPHY0%ALFX_HR-YRPHY0%ALFX_LR)))
  ENDDO
ENDIF
