...
temp (REAL(KIND=JPRB), ZKEDD, (KLON))


temp (REAL(KIND=JPRB), ZWD_PLUS_BUO, (KLON,KLEV))

temp (REAL(KIND=JPRB), ZTALF_SCE, (KLON))


temp (REAL(KIND=JPRB), ZTALF_SIN, (KLON))


temp (REAL(KIND=JPRB), ZDQCA, (KLON,0:KLEV))
temp (REAL(KIND=JPRB), ZFORM, (KLON,0:KLEV))
temp (REAL(KIND=JPRB), ZTBW, (KLON))
temp (REAL(KIND=JPRB), ZQBW, (KLON))
...
temp (REAL(KIND=JPRB), ZTB, (KLON))
temp (REAL(KIND=JPRB), ZS16, (KLON))
temp (REAL(KIND=JPRB), ZS15, (KLON))
temp (REAL(KIND=JPRB), ZRVH, (KLON))
temp (REAL(KIND=JPRB), ZRBH, (KLON))
temp (REAL(KIND=JPRB), ZRBB, (KLON))
temp (REAL(KIND=JPRB), ZQB, (KLON))
temp (REAL(KIND=JPRB), ZLH, (KLON))
temp (REAL(KIND=JPRB), ZLB, (KLON))
temp (REAL(KIND=JPRB), ZCP, (KLON))
...
temp (REAL(KIND=JPRB), ZQNH, (KLON))
temp (REAL(KIND=JPRB), ZTNH, (KLON))
temp (REAL(KIND=JPRB), ZLN, (KLON))

temp (REAL(KIND=JPRB), ZDEL_ORG, (KLON,KLEV))
temp (REAL(KIND=JPRB), ZEPS_ORG, (KLON,KLEV))
temp (REAL(KIND=JPRB), ZEPS_TUR, (KLON,KLEV))
temp (REAL(KIND=JPRB), ZCAPE, (KLON))

temp (REAL(KIND=JPRB), ZQBH, (KLON))
temp (REAL(KIND=JPRB), ZTBH, (KLON))
temp (REAL(KIND=JPRB), ZSIGMA, (KLON,0:KLEV))
temp (REAL(KIND=JPRB), ZKD, (KLON,KLEV))
REAL(KIND=JPRB) :: ZCPH,ZTNSEC,ZTVNL,ZTVEL
temp (REAL(KIND=JPRB), ZCAPEL, (KLON))
temp (REAL(KIND=JPRB), ZRBHS, (KLON))
temp (REAL(KIND=JPRB), ZRBBS, (KLON))

temp (REAL(KIND=JPRB), ZCINL, (KLON))
temp (REAL(KIND=JPRB), ZCIN, (KLON))
...
temp (REAL(KIND=JPRB), ZTAU, (KLON))
temp (REAL(KIND=JPRB), ZS11, (KLON))
temp (REAL(KIND=JPRB), ZS12, (KLON))
temp (REAL(KIND=JPRB), ZFMDQ, (KLON))
temp (REAL(KIND=JPRB), ZFMDS, (KLON))
REAL(KIND=JPRB) :: ZDLON,ZDLONL,ZFORMV
temp (REAL(KIND=JPRB), ZTAU_DIAG, (KLON))
temp (REAL(KIND=JPRB), ZFDXTAUX, (KLON))
REAL(KIND=JPRB) :: ZTD
temp (REAL(KIND=JPRB), ZBUOY, (KLON,KLEV))
temp (REAL(KIND=JPRB), ZQDN, (KLON,KLEV))
REAL(KIND=JPRB) :: ZDIVERG,ZBIN,ZTKLEV
temp (REAL(KIND=JPRB), ZQBASE, (KLON))
temp (REAL(KIND=JPRB), ZTBASE, (KLON))
...
temp (REAL(KIND=JPRB), ZDEPTH, (KLON))

temp (REAL(KIND=JPRB), ZASCENT_BASE, (KLON))
...
temp (REAL(KIND=JPRB), ZDIAG_WMAX, (KLON))
...
temp (INTEGER(KIND=JPIM), IBAC, (KLON))
temp (INTEGER(KIND=JPIM), INIVBAC, (KLON,KLEV))
temp (INTEGER(KIND=JPIM), INCDN, (KLON,KLEV))
temp (INTEGER(KIND=JPIM), ICDN, (KLON))
INTEGER(KIND=JPIM) :: IVVER,IDOMDP,IVVN,IVVX,INUA,ICHIS,IENTR
temp (INTEGER(KIND=JPIM), IQLIC, (KLON))
temp (INTEGER(KIND=JPIM), IKUO6, (KLON))
INTEGER(KIND=JPIM) :: IE0,ICIN

temp (INTEGER(KIND=JPIM), ILFC, (KLON))
temp (INTEGER(KIND=JPIM), INLFC, (KLON,KLEV))
temp (INTEGER(KIND=JPIM), ILEVTEN, (KLON))
temp (INTEGER(KIND=JPIM), IKUO5, (KLON))
...
temp (REAL(KIND=JPRB), ZS5, (KLON))
REAL(KIND=JPRB) :: ZEPS3
REAL(KIND=JPRB) :: ZE,ZR,ZTCOND
temp (REAL(KIND=JPRB), ZTEN, (KLON))
temp (REAL(KIND=JPRB), ZTEL, (KLON))
...
temp (REAL(KIND=JPRB), ZRME, (KLON))
temp (REAL(KIND=JPRB), ZPLH, (KLON))
...
temp (REAL(KIND=JPRB), ZRH, (KLON))
temp (REAL(KIND=JPRB), ZINTE, (KLON))
temp (REAL(KIND=JPRB), ZDENO, (KLON))
temp (REAL(KIND=JPRB), ZSATDEF, (KLON))
...
temp (REAL(KIND=JPRB), ZALFAVEC, (KLON))
temp (REAL(KIND=JPRB), ZLOGRATIO, (KLON))

temp (REAL(KIND=JPRB), ZEW_TLN, (KLON))
temp (REAL(KIND=JPRB), ZEW_TLE, (KLON))
temp (REAL(KIND=JPRB), ZTLN_ARR, (KLON))
temp (REAL(KIND=JPRB), ZTLE_ARR, (KLON))

temp (REAL(KIND=JPRB), ZDELTA_ARR, (KLON))
temp (REAL(KIND=JPRB), ZLOGSIGMA, (KLON))

temp (REAL(KIND=JPRB), ZT, (KLON,KLEV))
temp (REAL(KIND=JPRB), ZPREVIOUST, (KLON))
temp (REAL(KIND=JPRB), ZALF_CVGQ, (KLON))
temp (REAL(KIND=JPRB), ZIBCCS, (KLON))
temp (REAL(KIND=JPRB), ZCVGQ, (KLON))

temp (REAL(KIND=JPRB), ZALFX, (KLON))
...
temp (INTEGER(KIND=JPIM), IEL, (KLON))
temp (INTEGER(KIND=JPIM), IFCL, (KLON))
temp (INTEGER(KIND=JPIM), ILCL, (KLON))
