...
REAL(KIND=JPRB)    :: GCVGQX ! (in s^-1) MAXIMUM HUMIDITY CONVERGENCE, TO AVOID NUMERICAL PROBLEMS WHERE TIME-STEP TOO LARGE FOR VERTICAL RESOLUTION.
REAL(KIND=JPRB)    :: GINSTX ! (in K) MAXIMUM VERTICAL INSTABILITY OVER THE PBL, TO AVOID NUMERICAL PROBLEMS WHERE TIME-STEP TOO LARGE FOR VERTICAL RESOLUTION.
REAL(KIND=JPRB)    :: ALFX
