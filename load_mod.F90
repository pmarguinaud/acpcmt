...
SUBROUTINE DIFFX1 (CDNAME, X1, X1_1, LDPRINT)
CHARACTER (LEN=*) :: CDNAME
REAL (KIND=JPRB) :: X1 (:), X1_1 (:)
LOGICAL, OPTIONAL :: LDPRINT
LOGICAL :: LLPRINT
INTEGER :: I1
...
IF (LLPRINT) THEN
DO I1 = 1, SIZE (X1)
  WRITE (*, '(A32,I12,12X,E25.17)') CDNAME, I1, X1 (I1)
ENDDO
ELSE
DO I1 = 1, SIZE (X1)
...
SUBROUTINE DIFFX2 (CDNAME, X2, X2_1, LDPRINT)
CHARACTER (LEN=*) :: CDNAME
...
DO I1 = 1, SIZE (X2, 1)
DO I2 = 1, SIZE (X2, 2)
  WRITE (*, '(A32,I12,I12,E25.17)') CDNAME, I1, I2, X2 (I1, I2)
ENDDO
ENDDO
ELSE
DO I1 = 1, SIZE (X2, 1)
...
SUBROUTINE DIFFX3 (CDNAME, X3, X3_1, LDPRINT)
CHARACTER (LEN=*) :: CDNAME
...
DO I2 = 1, SIZE (X3, 2)
DO I3 = 1, SIZE (X3, 3)
  WRITE (*, '(A32,I12,I12,I12,E25.17)') CDNAME, I1, I2, I3, X3 (I1, I2, I3)
ENDDO
ENDDO
ENDDO
ELSE
