...
ALLOCATE (PSTACK_ALL (ISTSZ_ALL, ICOUNT1))

WRITE (*, *) " KLON0 = ", KLON0, " ICOUNT0 = ", ICOUNT0
WRITE (*, *) " KLON1 = ", KLON1, " ICOUNT1 = ", ICOUNT1
WRITE (0, *) __FILE__, ':', __LINE__, " SIZE (PALPH_ALL, 1) = ", SIZE (PALPH_ALL, 1)
WRITE (0, *) __FILE__, ':', __LINE__, " KTDIA = ", KTDIA
...
!$acc parallel loop gang vector private (IBL, JJ, JIDIA, JFDIA) collapse (2) vector_length(KLON)
...
DO IBL = 1, ICOUNT1
  ...
  CALL ACPCMT ( JIDIA,JFDIA,KLON,KTDIA,KLEV,KTRA,&
    ...
    & PGM_ALL (JJ,IBL), PTS_ALL (JJ,IBL), PQS_ALL (JJ,IBL), PNEIJ_ALL (JJ,IBL), &
    & PLSM_ALL (JJ,IBL), PVETAF_ALL (:,IBL), &
    ...
    & KNND_ALL (JJ,IBL), PCAPE_ALL (JJ,IBL),PAIPCMT_ALL (JJ,IBL),&
    & PALF_CAPE_ALL (JJ,IBL),PALF_CVGQ_ALL (JJ,IBL),&
