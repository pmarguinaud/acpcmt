...
INTEGER (KIND=JPIM) :: ISTPT_ALL, ISTSZ_ALL
...
INTEGER :: ICOUNT0, KLON0, NTIME, ITIME
...
ISTSZ_ALL = 220 * KLON * KLEV
ISTPT_ALL = 1

ALLOCATE (PSTACK_ALL (ISTSZ_ALL, ICOUNT))
...
!$acc parallel loop gang vector private (IBL, JJ, JIDIA, JFDIA) collapse (2) vector_length(KLON) copy &
!$acc & (PALPH_ALL, PAPHI_ALL, PAPHIF_ALL, PAPRS_ALL, PAPRSF_ALL, PCP_ALL, PLH_ALL, PR_ALL, &
!$acc &  PDELP_ALL, PLNPR_ALL, PQ_ALL, PQI_ALL, PQL_ALL, PRR_ALL, PS_ALL, PQLIS_ALL, PQSAT_ALL, PQW_ALL, &
!$acc &  PRDELP_ALL, PCVGQ_ALL, PT_ALL, PTW_ALL, PU_ALL, PV_ALL, PTKE_ALL, PTRA_ALL, PQLCONV_ALL,  &
!$acc &  PQICONV_ALL,  PQRCONV_ALL,  PQSCONV_ALL, PGM_ALL,  PTS_ALL,  PQS_ALL,  PNEIJ_ALL,  &
...
!$acc &  PFIMCC_ALL, PFPEVPCL_ALL, PFPEVPCN_ALL, PFPLCL_ALL, PFPLCN_ALL, PMF_UP_ALL, &
!$acc &  PFPFPCL_ALL, PFPFPCN_ALL, PFEDQLC_ALL,  PFEDQIC_ALL,  PFEDQRC_ALL,  PFEDQSC_ALL, &
!$acc &  PFCNEGQLC_ALL, PFCNEGQIC_ALL, PFCNEGQRC_ALL, PFCNEGQSC_ALL, KNLAB_ALL, PNEBC_ALL, PQLIC_ALL, &
!$acc &  PTU_ALL, PQU_ALL, PQC_DET_PCMT_ALL, PCSGC_ALL, KNND_ALL,  PCAPE_ALL, PAIPCMT_ALL, PALF_CAPE_ALL, &
!$acc &  PALF_CVGQ_ALL, PUDAL_ALL, PUDOM_ALL, PDDAL_ALL, PDDOM_ALL, ISTPT_ALL, ISTSZ_ALL, PSTACK_ALL )
...
DO IBL = 1, ICOUNT
  ...
  CALL ACPCMT ( JIDIA,JFDIA,KLON,KTDIA,KLEV,KTRA,&
    ...
    & ISTPT_ALL, ISTSZ_ALL, PSTACK_ALL (:, IBL))
