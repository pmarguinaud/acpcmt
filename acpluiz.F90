...
IF ( LDADJCLD ) THEN
  ...
  CALL ACNEBSM ( KIDIA,KFDIA,KLON,KTDIA,KLEV,&
               ...
               & PGM,PVETAF,&
               & PQCS,PNEBS,ZRHCRI,ZRMF,ZQSATS, KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT )
...
CALL ACMICRO ( KIDIA, KFDIA, KLON, KTDIA, KLEV,&
             ...
             & ZAUTOL, ZAUTOI, KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT )
...
CALL ADVPRCS ( KIDIA, KFDIA, KLON, KTDIA, KLEV,&
             ...
             & PSEDIQL, PSEDIQN, KSTACK, PSTACK, KPSTSZ, KKSTSZ, KPSTPT, KKSTPT )
