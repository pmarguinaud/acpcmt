...
SUBROUTINE ACPLUIZ( KIDIA, KFDIA, KLON, KTDIA, KLEV,&
 ...
 & PFPEVPL, PFPEVPN, PFPFPL, PFPFPN, PSEDIQL, PSEDIQN, KSTACK, PSTACK, KPSTSZ, KKSTSZ )
...
IF ( LDADJCLD ) THEN
  ...
  CALL ACNEBSM ( KIDIA,KFDIA,KLON,KTDIA,KLEV,&
               ...
               & PGM,PVETAF,&
               & PQCS,PNEBS,ZRHCRI,ZRMF,ZQSATS, KSTACK, PSTACK, KPSTSZ, KKSTSZ )
...
CALL ACMICRO ( KIDIA, KFDIA, KLON, KTDIA, KLEV,&
             ...
             & ZAUTOL, ZAUTOI, KSTACK, PSTACK, KPSTSZ, KKSTSZ )
...
CALL ADVPRCS ( KIDIA, KFDIA, KLON, KTDIA, KLEV,&
             ...
             & PSEDIQL, PSEDIQN, KSTACK, PSTACK, KPSTSZ, KKSTSZ )
